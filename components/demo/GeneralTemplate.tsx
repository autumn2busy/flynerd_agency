...
export default function GeneralTemplate({
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-yellow-400 selection:text-black font-sans">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="flex-1 space-y-8">
              ...
              <p className="text-xl text-neutral-400 max-w-2xl leading-relaxed">
                We took your business details and built a conversion-focused web portal designed
                specifically for {niche} professionals. No more generic templates — this is built
                to turn your local visibility into booked clients.
              </p>
                ...
                <div className="relative rounded-3xl border border-white/10 bg-neutral-900 shadow-2xl overflow-hidden aspect-video flex items-center justify-center">
                  {walkthroughVideoUrl ? (
                    walkthroughVideoUrl.includes(".mp4") ? (
                      ...
                      <iframe
                        src={
                          walkthroughVideoUrl.includes("/share/")
                            ? walkthroughVideoUrl.replace("/share/", "/embed/")
                            : walkthroughVideoUrl
                        }
          ...
          <div className="max-w-7xl mx-auto space-y-12 text-center">
            <div className="space-y-4">
              ...
              <p className="text-neutral-400">
                We identified these critical areas where the new demo outperforms your current
                presence:
              </p>
            </div>
        ...
        <section className="py-32 px-12 text-center max-w-4xl mx-auto space-y-12">
          ...
          <p className="text-xl text-neutral-400 leading-relaxed max-w-2xl mx-auto">
            ...
            testimonials, and booking links. We can have the full version launched in as little as
            48 hours.
          </p>
      ...
      <DemoChatWidget businessName={businessName} niche={niche} bookingLink={bookingLink} />
    </>
  );
}
